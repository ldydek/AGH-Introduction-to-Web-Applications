...
function leftButton() {
    ...
    imgBorder.animate(signsSpinning, signsTiming);
    job.animate(signsSpinning, signsTiming);
    decription.animate(signsSpinning, signsTiming);
    name.animate(signsSpinning, signsTiming);
    img.animate(signsSpinning, signsTiming);
